...
class FileHelper
{
    ...
    public static function file_put_contents(string $filename, mixed $data, int $flags = 0, $context = null): int
    {
        $result = file_put_contents($filename, $data, $flags, $context);
        if ($result === false) {
            throw new \RuntimeException("Can't put contents of the file \"{$filename}\"");
        }
        return $result;
    }
}
